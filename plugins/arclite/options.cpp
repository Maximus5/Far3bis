...
const wchar_t* c_param_extract_open_dir = L"extract_open_dir";
...
const bool c_def_extract_open_dir = false;
...
void Options::load() {
  ...
  extract_open_dir = key.get_bool(c_param_extract_open_dir, c_def_extract_open_dir);
...
void Options::save() const {
  ...
  key.set_bool(c_param_extract_open_dir, extract_open_dir, c_def_extract_open_dir);
