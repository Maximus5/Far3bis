...
*/
BOOL DECLSPEC idPRParceSkirdin( const PFTPServerInfo Server, PFTPFileInfo p, char *entry, int entry_len )
...
*/
BOOL DECLSPEC idDirParceSkirdin( const PFTPServerInfo Server, CONSTSTR Line, char *CurDir, size_t CurDirSize )
  {
    char *Ptr;
