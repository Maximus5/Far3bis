...
/****************************************
   TrafficInformation
 ****************************************/
void TrafficInformation::DrawInfo( PInfoItem it,time_t tm )
  {  static char str[FAR_MAX_PATHSIZE+1];
     double db;
     int    cn;
     time_t tmp;
     struct tm *ltm;
