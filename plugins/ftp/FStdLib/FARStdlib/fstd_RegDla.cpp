...
BOOL DECLSPEC FP_DeleteRegKeyAll( CONSTSTR hParentKey,CONSTSTR Key )
...
BOOL DECLSPEC FP_DeleteRegKeyAll( CONSTSTR Key )
  {  char  name[ FAR_MAX_REG ];
...
BOOL DECLSPEC FP_DeleteRegKeyAll( HKEY hParentKey, CONSTSTR szKey )
