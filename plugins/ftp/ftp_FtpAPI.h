...
int    FtpConnectMessage( Connection *hConnect,int Msg,CONSTSTR HostName,int BtnMsg = MNone__,int btn1 = MNone__, int btn2 = MNone__ );
...
BOOL   FtpGetFile(Connection *hConnect,CONSTSTR lpszRemoteFile,CONSTSTR lpszNewFile,BOOL Reget,int AsciiMode );
int    FtpGetRetryCount( Connection *hConnect );
BOOL   FtpIsResume( Connection *hConnect );
BOOL   FtpPutFile(Connection *hConnect,CONSTSTR lpszLocalFile,CONSTSTR lpszNewRemoteFile,BOOL Reput,int AsciiMode );
BOOL   FtpRemoveDirectory(Connection *hConnect,CONSTSTR lpszDirectory);
BOOL   FtpRenameFile(Connection *hConnect,CONSTSTR lpszExisting,CONSTSTR lpszNew);
BOOL   FtpSetCurrentDirectory(Connection *hConnect,CONSTSTR lpszDirectory);
