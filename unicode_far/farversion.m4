...
m4_define(FULLVERSION32,MAKEFULLVERSION(BUILDTYPE32,`x86'))m4_dnl
m4_define(FULLVERSION64,MAKEFULLVERSION(BUILDTYPE64,`x64'))m4_dnl
m4_define(FULLVERSIONIA64,MAKEFULLVERSION(BUILDTYPEIA64,`IA64'))m4_dnl
