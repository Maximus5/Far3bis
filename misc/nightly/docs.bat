...
plugins\common\convert.exe addons\Shell\Descript.ion addons\Shell\FARHere.inf %1\Addons\Shell\

plugins\common\convert.exe addons\XLat\Descript.ion %1\Addons\XLat\
plugins\common\convert.exe addons\XLat\Russian\AltR.reg addons\XLat\Russian\Apps.reg addons\XLat\Russian\CtrlR.reg addons\XLat\Russian\Descript.ion addons\XLat\Russian\CtrlShiftX.reg %1\Addons\XLat\Russian\
